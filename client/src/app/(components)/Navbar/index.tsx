    ...
    return (
        <div className="flex justify-between items-center w-full mb-7">
            ...
            <div className="flex justify-between items-center gap-5">
                <button className="px-3 py-3 bg-gray-100 rounded-full hover:blue-100" onClick={toggleSidebar}>
                    <Menu className='w-4 h-4' />
                </button>

                <div className='relative'>
                    <input type="search" placeholder='Start type tp search groups and products' className='pl-10 pr-4 py-2 w-50 md:w-60 border-2 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500' />
            ...
            <div className='flex justify-between items-center gap-5'>
                <div className='hidden md:flex justify-between items-center gap-5'>
                    ...
                    <div className='flex items-center gap-3 cursor-pointer'>
                        ...
                        <span className='font-semibold'>Ashu</span>
                    </div>
                </div>
                <Link href='/settings'>
